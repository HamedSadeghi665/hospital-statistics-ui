...
import service from "../../../../services/settings/users-info/doctors-service";
import {
  getSorter,
  checkAccess,
  getColumns,
...
const baseColumns = [
  {
    ...
    align: "center",
    dataIndex: "DoctorID",
    sorter: getSorter("DoctorID"),
    render: (DoctorID) => <Text>{utils.farsiNum(`${DoctorID}`)}</Text>,
  },
  {
    title: "",
    width: 45,
