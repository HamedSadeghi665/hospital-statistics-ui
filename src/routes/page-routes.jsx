...
import DeathFormsPage from "../components/app-modules/settings/main-info/death-forms-page";
//--- Access Pages
...
const PageRoutes = ({ path }) => {
  return (
    <Switch>
      ...
      />
      <ProtectedRoute
        path={`${path}/main-info/death-forms`}
        exact
        render={() => <DeathFormsPage pageName="DeathForms" />}
      />
      <ProtectedRoute
